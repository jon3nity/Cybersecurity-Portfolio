...
**John Onyekachi | Atlantic Technological University, Letterkenny**
...
│   ├── IPv4-Addressing/              → Subnetting, CIDR, VLSM calculations
│   ├── Router-Configuration/         → Cisco IOS, RIP, OSPF, static routes
│   ├── VLAN-Security/                → Network segmentation, attack containment
